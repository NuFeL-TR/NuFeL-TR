...
if [[ $1 =~ ^(-h|--help|-y|--yardım) ]] ; then
    ...
    echo "----------------------------------------------------------"
    echo -e $cyan"    Create by           $white":" $red ByEXTAZY$tp"
    echo -e $cyan"    Github              $white":" $red https://github.com/ByEXTAZY$tp"
    echo -e $cyan"    Instagram           $white":" $red @EXTAZYY.DLL$tp"
    echo -e $cyan"    Developer           $white":" $red https://github.com/EXTAZY ÇAKIROĞLU$tp"
    exit 0
fi
...
echo -e "${blink}${lightgreen}  |$tp ${cyan}Create by           $white":" $red TR DOĞUKAN ÇAKIROĞLU TR$tp ${blink}${lightgreen}                        |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Github              $white":" $red https://github.com/EXTAZY$tp ${blink}${lightgreen}     |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Instagram           $white":" $red EXTAZYY.DLL$tp ${blink}${lightgreen}                  |$tp"
echo -e "${blink}${lightgreen}  ---------------------------------------------------------$tp\n"
echo "  ~~~~~~~~~~~~~~~~~~~~~ BCHackTool ~~~~~~~~~~~~~~~~~~~~~~~~~" 
        echo ""
        echo " [1] ✔ Inshackle              [2] ✔ Kickthemout" 
        echo " [3] ✔ Zphisher               [4] ✔ UserRecon (Kişi Arama Sosyal Medya)" 
        echo " [5] ✔ Insta Şifre Saldırı    [6] ✔ Cupp" 
        echo " [7] ✔ SpamWa(Sms Spam)       [8] ✔ Ip-Tracer (Ip Bilgisi)" 
        echo " [9] ✔ OSIF                   [10] ✔ CamHackers (Admin Panel Bulucu)" 
        echo " [11] ✔ TheFatRat             [12] ✔ RequiredEx(Sistem Pr.)"
	echo " [13] ✔ RED_HAWK              [14] ✔ Ghost" 
        echo " [x] ✔ Exit" 
        echo ""
        echo -ne "❨${red}EXTAZY${tp}❩:(${blue}./DOĞUKAN@ÇAKIROĞLU${tp})\n↳[${blink}${lightcyan}*${tp}]➢ " ; read option
        ...
        case "$option" in 
            ...
            x)
                clear
                cat banners/bcbanner
                echo " EXHackTool Programini Tercih Ettiginiz Icin Tesekkurler {TR DOĞUKAN ÇAKIROĞLU TR} !!" 
                echo ""
                exit 0
                ;;
        esac
