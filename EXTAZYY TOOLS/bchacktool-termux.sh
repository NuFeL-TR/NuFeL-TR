...
if [[ $1 =~ ^(-h|--help|-y|--yardım) ]] ; then
    ...
    echo "----------------------------------------------------------"
    echo -e $cyan"    Create by           $white":" $red EXTAZY$tp"
    echo -e $cyan"    Github              $white":" $red https://github.com/EXTAZY$tp"
    echo -e $cyan"    Instagram           $white":" $red @extazyy.dll$tp"
    echo -e "$cyan    Discord            $white : $red https://discord.io/EXTAZY$tp"
    echo -e "$cyan    Tester             $white : $red CruelMSA$tp"
    echo -e "$cyan    Developper         $white : $red https://github.com/extazy7007$tp"
    exit 0
...
echo -e "[${blink}${yellow}*${tp}]$blue BCHackTool Programini Tercih Ettiginiz Icin Tesekkurler  {DOĞUKAN ÇAKIROĞLU} :)$tp"
exit 0
}
...
echo -e "${blink}${lightgreen}  |$tp ${cyan}Create by           $white":" $red EXTAZY$tp ${blink}${lightgreen}                        |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Discord             $white":" $red https://discord.io/EXTAZY.DLL${blink}${lightgreen}      |$tp"
...
echo " ~~~~~~~~~~~~~~~~~~~~~ ByExtazy Termux ~~~~~~~~~~~~~~~~~~~~~~~~~" 
        ...
        case "$option" in
            ...
            q) 
                clear
                cat banners/bcbanner
                echo " BCHackTool Programini Tercih Ettiginiz Icin Tesekkurler {ExtazyTR} !!" 
                echo ""
                exit 0
                ;;
        esac
